 ...
 * Paper, editorial. Thick-bordered input + tactile button. POSTs to
 * /api/subscribe (Resend + DB seam); shows the right message for whether a real
 * confirmation email is on its way yet.
 */
  ...
  return (
    <section className="relative py-20 sm:py-28">
      <div className="mx-auto max-w-3xl px-5 text-center">
        <Reveal>
          <p className="font-mono text-[12px] uppercase tracking-[0.2em] text-up">
          ...
          <AnimatePresence mode="wait">
            {status === "success" ? (
              <motion.div
                ...
                className="mx-auto flex max-w-md flex-col items-center gap-2 rounded-2xl border-2 border-ink bg-paper p-7 shadow-hard-sm"
              >
